...
const fallbackBookings = [
  { bookingId: 'BK-9821', customerName: 'Sarah Jenkins', customerPhone: '+91 98450 11223', serviceName: 'House Deep Cleaning', subService: '3BHK Comprehensive Sanitization', amount: 3499, status: 'confirmed', date: '2026-09-05', time: '10:00 AM', paymentMethod: 'UPI / Online', createdAt: '2026-09-05T08:30:00Z' },
  { bookingId: 'BK-9820', customerName: 'David Miller', customerPhone: '+91 98451 22334', serviceName: 'Vehicle Cleaning', subService: 'SUV Foam Wash & Interior Detailing', amount: 1299, status: 'assigned', date: '2026-09-05', time: '11:30 AM', paymentMethod: 'Razorpay / Card', createdAt: '2026-09-05T09:00:00Z' },
  { bookingId: 'BK-9819', customerName: 'Elena Rostova', customerPhone: '+91 98452 33445', serviceName: 'Kitchen Deep Clean', subService: 'Degreasing & Chimney Sanitization', amount: 1899, status: 'completed', date: '2026-09-04', time: '02:00 PM', paymentMethod: 'UPI / GPay', createdAt: '2026-09-04T12:00:00Z' },
  { bookingId: 'BK-9818', customerName: 'Michael Chen', customerPhone: '+91 98453 44556', serviceName: 'House Deep Cleaning', subService: '2BHK Move-in Deep Clean', amount: 2799, status: 'pending', date: '2026-09-05', time: '04:00 PM', paymentMethod: 'Cash on Service', createdAt: '2026-09-05T09:45:00Z' },
  { bookingId: 'BK-9817', customerName: 'Amanda Ross', customerPhone: '+91 98454 55667', serviceName: 'Vehicle Cleaning', subService: 'Sedan Exterior Steam Wash', amount: 899, status: 'in-progress', date: '2026-09-05', time: '01:00 PM', paymentMethod: 'UPI / PhonePe', createdAt: '2026-09-05T10:15:00Z' },
  { bookingId: 'BK-9816', customerName: 'Anil Kumble', customerPhone: '+91 98455 66778', serviceName: 'Bathroom Deep Clean', subService: 'Tile Descaling & Stain Removal', amount: 999, status: 'completed', date: '2026-09-04', time: '05:30 PM', paymentMethod: 'Card / NetBanking', createdAt: '2026-09-04T14:30:00Z' },
  { bookingId: 'BK-9815', customerName: 'Rashmi Verma', customerPhone: '+91 98456 77889', serviceName: 'Sofa & Upholstery Cleaning', subService: '5-Seater Shampoo Treatment', amount: 1599, status: 'confirmed', date: '2026-09-06', time: '09:30 AM', paymentMethod: 'UPI', createdAt: '2026-09-05T11:00:00Z' },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Manage, track, assign, and review customer service requests across all categories.</p>
        </div>
